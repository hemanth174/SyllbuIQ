...
export function SearchModal({
  ...
  const panel = (
    <div
      ...
      {/* Search bar */}
      <div
        className="flex items-center gap-1 border-b border-black/[0.06] px-4 py-3.5 dark:border-white/[0.06]">
        ...
        <div className="flex shrink-0 items-center gap-2.5">
          ...
          <kbd
            className="flex items-center gap-0.5 rounded-md border border-black/[0.06] bg-black/[0.03] px-1.5 py-0.5 font-sans text-[11px] font-medium text-neutral-400 dark:border-white/[0.08] dark:bg-white/[0.06] dark:text-neutral-500">
      ...
      {activeTags.length > 0 ? (
        <div
          className="border-b border-black/[0.06] px-4 py-3.5 dark:border-white/[0.06]">
              ...
              <li key={`${result.name}-${i}`}>
                <a
                  ...
                  {result.actions && result.actions.length > 0 ? (
                    <span
                      className="ml-auto flex items-center gap-2.5 pl-3 text-neutral-400 opacity-70 transition-opacity group-hover:opacity-100 dark:text-neutral-500">
      ...
      {quickActions.length > 0 ? (
        <div
          className="border-b border-black/[0.06] px-1.5 py-1.5 dark:border-white/[0.06]">
          <p
            className="px-2.5 pt-2 pb-1 text-[13px] text-neutral-400 dark:text-neutral-500">Quick actions</p>
          {quickActions.map((action, i) => (
            <button
              ...
              <span
                className="flex h-[30px] w-[30px] shrink-0 items-center justify-center rounded-lg bg-black/[0.04] text-neutral-500 dark:bg-white/[0.06] dark:text-neutral-300">
                {action.icon ?? <Plus className="h-[15px] w-[15px]" />}
              </span>
              <span className="pl-3 text-sm">{action.label}</span>
              {action.shortcut ? (
                <kbd
                  className="ml-auto flex h-[26px] w-[26px] items-center justify-center rounded-md bg-black/[0.04] font-sans text-[13px] text-neutral-500 ring-1 ring-inset ring-black/[0.04] dark:bg-white/[0.06] dark:text-neutral-300 dark:ring-white/[0.06]">
                  {action.shortcut}
                </kbd>
              ) : null}
            </button>
      ...
      {files.length > 0 ? (
        <div className="px-1.5 py-1.5">
          <p
            className="px-2.5 pt-2 pb-1 text-[13px] text-neutral-400 dark:text-neutral-500">
